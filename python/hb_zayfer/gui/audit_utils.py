...
def log_file_encrypted(algorithm: str, filename: str, size_bytes: int | None = None, view: str = "encrypt") -> None:
    audit_safe(hbz.audit_log_file_encrypted, algorithm, filename, size_bytes, f"source=gui, view={view}")


def log_file_decrypted(algorithm: str, filename: str, size_bytes: int | None = None, view: str = "decrypt") -> None:
    audit_safe(hbz.audit_log_file_decrypted, algorithm, filename, size_bytes, f"source=gui, view={view}")
